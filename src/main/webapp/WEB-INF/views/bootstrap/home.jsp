...
<title>Spring Paddle Home</title>
</head>
<body>
			...
			<nav class="navbar navbar-inverse navbar-static-top">
				<div class="container">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="#">Spring Paddle</a>
					</div>
					<div id="navbar" class="navbar-collapse collapse">
						<ul class="nav navbar-nav">
							...
							<li class="dropdown"><a href="#" class="dropdown-toggle"
								...
								aria-expanded="false">Court<span class="caret"></span></a>
								<ul class="dropdown-menu">
									<li class="dropdown-header">CRUD</li>
									<li><a href="<c:url value='/court-list'/>">Lista de pistas</a></li>
									<li><a href="<c:url value="/create-court"/>">Crear pista</a></li>
								</ul></li>
						</ul>
					</div>
				</div>
		...
		<div class="carousel-inner" role="listbox">
			<div class="item active">
				...
				<div class="container">
					<div class="carousel-caption">
						<h1>Empezar con Spring Paddle</h1>
			...
			<div class="item">
				...
				<div class="container">
					<div class="carousel-caption">
						<h1>Crear pista</h1>
						<p>Saca un formulario para crear una nueva pista</p>
						<p>
							<a class="btn btn-lg btn-primary"
